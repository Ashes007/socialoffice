                ...
                <!--------------------------------------------- -->
                 ...
                 <tr>
                  ...
                  <tr>
                    ...
                    <td align="center">
                      <div class="checkbox icheck">
                        <label>{{ Form::checkbox('permission[]', $permissions['event']['post']['id'], $role->hasPermission($permissions['event']['post']['name']), ['class' => '']) }}</label>
                      </div>
                    </td>
                    <td align="center">
                      <div class="checkbox icheck">
                        <label>{{ Form::checkbox('permission[]', $permissions['event']['like']['id'], $role->hasPermission($permissions['event']['like']['name']), ['class' => '']) }}</label>
                      </div>
                    </td>
                    <td>&nbsp;</td>                                                            
                  </tr>

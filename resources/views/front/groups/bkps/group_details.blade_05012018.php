               ...
               <div class="row">
                 <div class="col-sm-6">
                   <ul class="nav-varient">
                     ...
                     <li><a href="#" class="con-choose-image"><input name="post_image" id="userImage" type="file" class="inputFile" onChange="showPreview(this);" /> <i class="fa fa-camera" aria-hidden="true"></i></a></li>
                   </ul>
                 </div>
              ...
              function showPreview(objFileInput) {
                  if (objFileInput.files[0]) {
                      ...
                      fileReader.onload = function (e) {
                          $("#targetLayer").html('<img src='{{ asset('frontend/images/cross.png')}}' /><img src="'+e.target.result+'" class="upload-preview" />');
             ...
             <div class="timelineBlock">
              ...
              <?php  } ?>
               ...
               <div class="postedTime-image">
                <?php if(file_exists( public_path('uploads/post_images/thumb/'.$post->image) )&& ($post->image!='' || $post->profile_photo!=NULL)) {?>
               <img src="{{ asset('uploads/post_images/thumb/').'/'.$post->image }}"/>
               <?php }?>               
                 <h2>{{$post->text}}</h2>
               </div>

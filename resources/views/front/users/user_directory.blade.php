...
<div class="home-container">
    <div class="container">
     <div class="emDirectory-tiTle">
       <h2 class="animated zoomIn">{{ trans('home.Employee_Directory_Search') }}</h2>
     </div>
    </div>
    <div class="emDirectory-wRapper">
       <div class="emDirectory-seaRch">
         <div class="container">
           <div class="row">
             <div class="col-sm-7">
                <div class="emDirectory-tiTle">
         		<!-- <h2>{{ trans('home.Employee_Directory') }}</h2> -->
       			</div>
             </div>
             <div class="col-sm-5">
               <div class="searchSt forSearch">
                 <input type="text" name="search" value="" placeholder="{{ trans('home.Search') }}..." id="search-box">
                 <div id="stats"></div>
               </div>
             </div>
           </div>
      ...
      <div class="numWrap">
       <div id="numMenu" class="content slidemenu">
         ...
         <ul id="controls">
          <li><a id='all' href=''><span>{{ trans('home.All') }}</span></a></li>
         <?php 
       ...
       <script id="movie" type="text/x-handlebars-template">
         <li class="@{{alpha}}">
             ...
             <div class="blockSingle-img"><img src="{{$image_url}}@{{profile_photo}}" alt=""></div>

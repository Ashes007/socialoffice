...
<?php endif; ?>
        ...
        <section class="createEventSection">
            <div class="createEventSection-close">
                <a href="<?php echo e(URL::Route('event','month')); ?>"><?php echo e(trans('common.cancel')); ?>
            ...
            <div class="msg"><?php echo e(Session::get('success')); ?></div>
                ...
                <div class="fullHeight formstartContainer startForm">
                    <div class="absCont">
                        ...
                        <div class="ceCircle">
                            ...
                            <div class="ceTitle"><?php echo e(trans('createEvent.create_event')); ?></div>
                        </div>
                ...
                <div class="typeFormContainer">
                    <div class="formContainerInn ">
                        ...
                        <form method="post" action="<?php echo e(URL::Route('add_event')); ?>" class="typeForm" name="eventForm" id="eventForm" enctype = "multipart/form-data" >
                        <?php echo e(csrf_field()); ?>
                            ...
                            <ul class="formList mainForm">
                                ...
                                <li class="formSection formMove">
                                    ...
                                    <div class="inputField">
                                        ...
                                        <div class="fiLeCustom">
                                            <label for="file-upload-profile" class="custom-file-upload"><?php echo e(trans('common.drag_and_drop_your_files_here_or')); ?>
                                ...
                                <li class="formSection formMove">
                                    ...
                                    <div class="proceedContainer spaceOne">
                                        <h5>
                                            <a href="javascript:void(0)" class="ceBtnBlue proceedToNext"><?php echo e(trans('buttonTxt.proceed')); ?></a> <?php echo e(trans('common.or')); ?>
                                ...
                                <li class="formSection formMove">
                                    <div class="inputTitle">
                                        <span class="numberText">5</span> <?php echo e(trans('createEvent.You')); ?> 
                                        <span class="textOne"><?php echo e(trans('createEvent.Creating')); ?></span> <?php echo e(trans('createEvent.a')); ?> * </div>
                                    <div class="inputField eventType">
                                        <ul>
                                        <?php if(Auth::user()->can('add-global-event')==1 ): ?>
                                            <li class="eventOne eventTypeId" data-typeid="1">
                                                <h3><?php echo e(trans('createEvent.Global')); ?>

                                                    <br><?php echo e(trans('createEvent.Event')); ?></h3>
                                            </li>
                                        <?php endif; ?>
                                        <?php if(Auth::user()->can('add-departmental-event')==1 ): ?>
                                            <li class="eventTwo eventTypeId" data-typeid="2">
                                                <h3><?php echo e(trans('createEvent.Departmental')); ?>

                                                    <br><?php echo e(trans('createEvent.Event')); ?></h3>
                                            </li>
                                        <?php endif; ?>
                                        <?php if(Auth::user()->can('add-activity-event')==1 ): ?>
                                            <li class="eventThree eventTypeId" data-typeid="3">
                                                <h3><?php echo e(trans('createEvent.Open')); ?>
                                ...
                                <li class="formSection formMove noAuto dmargin">
                                    <div class="inputTitle">
                                        <span class="numberText">6</span> <?php echo e(trans('createEvent.Where_are_you')); ?>

                                        <span class="textOne"><?php echo e(trans('createEvent.conducting')); ?></span> <?php echo e(trans('createEvent.your_Event')); ?> *
                                    </div>
                                    <div class="inputField withArr">
                                        <input class="chosen-value formTextField enterinput" id="autocomplete" placeholder="<?php echo e(trans('createEvent.Type_or_select_an_option')); ?>" name="location" onFocus="geolocate()" type="text">
                                ...
                                <li class="formSection formMove">
                                    <div class="inputTitle">
                                        <span class="numberText">7</span> <?php echo e(trans('createEvent.When_you_are')); ?>
                                ...
                                <li class="formSection formMove">
                                    <div class="inputTitle">
                                        <span class="numberText">8</span> <?php echo e(trans('createEvent.What_is_the')); ?>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="inp-custom">
                                                    ...
                                                    <span class="qFday"> <?php echo e(trans('createEvent.Is_it_a_full_day_event')); ?> 
                                                        <span class="textOne" id="fullday_or"> -<?php echo e(trans('createEvent.OR')); ?> -</span></span>
                                                </div>
                            ...
                            <div class="container">
                                <div class="proceedContainer">
                                    <h5>
                                        <input type="submit" value="<?php echo e(trans('buttonTxt.submit')); ?>" class="ceBtnBlue"> <?php echo e(trans('common.or')); ?>

                                        <span class="pressText" id="submitpresstxt"><?php echo e(trans('common.press')); ?></span> <?php echo e(trans('common.enter')); ?></h5>
    ...
    $('#end_time').val(time);
        ...
        $("#eventForm").on('submit',(function(e){
                ...
                if($file == '')
                {
                    $.alert({
                        title: '<?php echo e(trans('common.Alert')); ?>',
                        content: '<?php echo e(trans('createEvent.Please_upload_an_image')); ?> ',
                        icon: 'fa fa-rocket',
                        type: 'blue',
                        animation: 'scale',
                        closeAnimation: 'scale',
                ...
                if($('#checktime').val() === 'No')
                {
                    ...
                    if($start_time > $end_time)
                    {
                        $.alert({
                            title: '<?php echo e(trans('common.Alert')); ?>',
                            content: '<?php echo e(trans('createEvent.End_time_must_be_greater_than_start_time')); ?>',
                            icon: 'fa fa-rocket',
                            type: 'blue',
                            animation: 'scale',
                            closeAnimation: 'scale',

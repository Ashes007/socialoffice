...
<div id="wrap">
    <div class="cube">
      <section class="page active face front" id="home">
          ...
          <span  class="animated zoomIn"><?php echo e(trans('usersAfterLogin.Registration')); ?></span>
      ...
      <div class="reg-body">
            <p><?php echo e(trans('usersAfterLogin.You_are')); ?> <input type="text" value="<?php echo e($userInfo->display_name); ?>" readonly="readonly" placeholder="Full Name" data-autosize-input='{ "space": 20 }' />, <?php echo e(trans('usersAfterLogin.working_in_our')); ?> <input type="text" class="in2" value="<?php echo e($userInfo->department->name); ?>" readonly="readonly" placeholder="Department" data-autosize-input='{ "space": 20 }' /> <?php echo e(trans('usersAfterLogin.Department_as')); ?><input type="text" class="in3" value="<?php echo e($userInfo->designation->name); ?>" readonly="readonly" placeholder="Title" data-autosize-input='{ "space": 20 }' />.</p>
              ...
              <p><?php echo e(trans('usersAfterLogin.You_have_joined')); ?><input type="text" class="in3" value="<?php echo e($userInfo->company->name); ?>" readonly="readonly" placeholder="Company" data-autosize-input='{ "space": 20 }' /> <?php echo e(trans('usersAfterLogin.on')); ?> <input type="text" name="date_of_joining" id="date_of_joining"  placeholder="DD/MM/YYYY" data-date-format="dd/mm/yyyy" value="<?php echo e(($userInfo->date_of_joining != '') ? \DateTime::createFromFormat('Y-m-d', $userInfo->date_of_joining)->format('d/m/Y') : ''); ?>" readonly="readonly" class="date" />.</p>

              <p><?php echo e(trans('usersAfterLogin.Can_you_tell_me_your_date_of_birth')); ?><input type='text' placeholder="DD/MM" name="birthday" id="birthday" readonly="readonly"  data-date-format="dd/mm" class="date1" value="<?php echo e(($userInfo->date_of_joining != '') ? \DateTime::createFromFormat('Y-m-d', $userInfo->date_of_birth)->format('d/m') : ''); ?>" data-autosize-input='{ "space": 20 }'/>.</p>
            ...
            <header>
              ...
              <a class="skip_first" href="<?php echo e(URL::Route('home')); ?>"><?php echo e(trans('usersAfterLogin.Skip')); ?></a></li>
            </header>
          </div>
        </div>
            </div>
     ...
     <?php echo Form::hidden('page_name','after-login'); ?>
      ...
      <div class="reg-body reg-body2">
          ...
          <span id="charNum"></span>
              ...
              <p><?php echo e(trans('usersAfterLogin.Please_upload_an_image_of_yourself')); ?></p>
                <div class="croppings">
                  ...
                  <label for="open" style="width: 90%; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; display: block;">
                    ...
                    <?php echo e(trans('usersAfterLogin.Browse_your_files')); ?>
              ...
              <input type="submit" value="<?php echo e(trans('usersAfterLogin.submit')); ?>"/> <span><?php echo e(trans('usersAfterLogin.or')); ?></span> <a href="<?php echo e(URL::Route('home')); ?>"><?php echo e(trans('usersAfterLogin.Skip')); ?></a>
              </div>
          </div>
...
<script src="<?php echo e(asset('frontend/js/CropBox.js')); ?>"></script>
  <script type="text/javascript">
    ...
    $(window).load(function () {
      ...
      $('.buttonCrop').on('click', function () { //#btnCrop
